...
__In Class Code:__  [ancova, mlr, and aic](./in_class_code/2018/scripts/mlr_int_aic.R)  
...
```
`r datestring`   
__Lecture:__  Causal Inference and Experimental Design  
...
__Reading:__ [Scientist’s guide to developing explanatory statistical models using causal analysis principles](readings/Grace_and_Irvine_2019.pdf), [Simplicity and Complexity in Ecological Data Analysis](./readings/Murtaugh_2007_Ecology.pdf)  
__Lab:__ Discussion of papers
