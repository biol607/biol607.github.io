...
```
`r datestring`   
__Lecture/Lab:__  [Working with Data](https://datacarpentry.github.io/R-ecology-lesson/working-with-data.html)     
<!--, [Joins](lectures/18_join.html)  -->
__Data:__ [Portal Data](https://datacarpentry.org/R-ecology-lesson/data/cleaned/surveys_complete_77_89.csv) - and learn more [here](https://portal.weecology.org/)  
