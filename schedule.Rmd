...
```
`r datestring`   
__Lecture:__ Ways of Knowing: [Cross-Validation and AIC](./lectures/crossvalidation.html), [Bayesian Inference](lectures/15_bayesian_basics.html), [Fitting a line with Bayesian techniques](lectures/16_bayesian_lm.html)  
