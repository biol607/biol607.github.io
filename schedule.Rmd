...
### Week 1. 
`r datestring`   
__Lecture:__ [How do we use data to understand how the world works?](lectures/01_intro.html), [Intro to R](lectures/02_r_intro.html). \
__Lab:__ [Matrices, Lists and Data Frames](lectures/02a_r_intro_list_matrix_df.html). [Introduction to Markdown](lab/01_markdown_intro.html)    
...
__In Class Code:__ [Code from Lab](in_class_code_2020/scripts/01_my_first_r_file.R)\
