...
```
`r datestring`   
__Lecture:__ Ways of Knowing: [NHST](./lectures/linear_regression_nht) and [Likelihood with Cross-Validation](lectures/13_likelihood.html), [Fitting a line with Likelihood](lectures/14_likelihood_2.html)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/607-lm-eval-2020  
