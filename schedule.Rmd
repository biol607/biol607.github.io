...
__MIDTERM__: Due Tues Nov 17th, 5pm. [Get it here](exams/exam_2023.html)  
...
```
`r datestring`   
__Lecture:__   [Causal Inference and Experiments](./lectures/causality_experiments.pptx), [Using causal models to get valid inference from observational and quasi-experimental studies](lectures/causal_observational.pptx)    
...
__Reading:__   [Kimmel et al. on Experimental Design](./readings/Kimmel_et_al_2021.pdf), [The Causal Dag and Haunted Terror](./readings/McElreath_Ch_6.pdf), [Butsic et al 2021 on Quasi-Experiments](readings/butsic_et_al_2017.pdf),   
__Optional Reading:__  [A Beastiary of Experimental Designs](readings/Gotelli&EllisonChapter7.pdf), [Bellemare et al. on Front Doors](BellemareBloemWexlerFDCJune2020.pdf)    
__Etherpad:__ https://etherpad.wikimedia.org/p/607-causal-expts-2023  
...
```
`r datestring`   
__Lecture:__ Ways of Knowing: [NHT](./lectures/linear_regression_nht), [NHT and testing models](lectures/freq_testing.html), [Power Analysis](./lectures/power_analysis_tidy.html)    
...
__Reading:__ [AIC in Behavioral Ecology](https://link.springer.com/article/10.1007/s00265-010-1029-6), [Fieberg on Modeling Strategies](https://fw8051statistics4ecologists.netlify.app/mmi), [Aho et al. 2014 on BIC](./readings/Aho_2014_ecolog_bic.pdf)   
