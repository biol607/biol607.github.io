...
__MIDTERM__: Due Tues April 4th, 5pm. [Get it here](exams/exam_2023.html)  
...
__Reading:__  [Arif et al. on Structural Causal Models](./readings/Arif_et_al_2022.zip), [Fieberg on Causal Inference](https://statistics4ecologists-v3.netlify.app/07-causalnetworks).   
...
```
`r datestring`   
__Lecture:__   [Causal Inference and Experiments](./lectures/causality_experiments.pptx)  
...
```
`r datestring`   
__Lecture:__ [Using causal models to get valid inference from observational and quasi-experimental studies](lectures/causal_observational.pptx)    
