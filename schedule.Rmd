...
```
`r datestring`   
__Lectures:__ May Predictors: [Multiple Linear Regression](./lectures/23_general_linear_model.html), [Multple Categorical Predictor Types](lectures/anova_2.html)    
__Lab Topic:__  Models with many types of predictors  
...
```
`r datestring`   
__Lectures:__ [Factorial ANOVA](lectures/anova_3.html), [Interaction Effects and the General Linear Model](./lectures/23_general_linear_model.html)    
...
__Etherpad:__ https://etherpad.wikimedia.org/p/607-mlr-2022  
...
```
`r datestring`   
__Lecture:__ Beyond Linear Regression, But Still Linear [Generalized Least Squares and Modeling Error](./lectures/gls.html), [Entering a non-normal world with Generalized Linear Models](lectures/25_generalized_linear_models.html)   
...
```
`r datestring`   
__Lecture:__  Structural Causal Models and Sampling Design. [Causal Inference and Experiments](./lectures/causality_experiments.pptx) 
__Reading:__ [Experimental Design Reading Packet](readings/exp_design_papers.zip)    
...
```
`r datestring`   
__Lecture:__   [Fundamental Experimental Designs from a Causal Perspective](lectures/expt_designs.pptx), [Using causal models to get valid inference from observational and quasi-experimental studies](lectures/causal_models_regression.pptx)  
__Reading:__ [A Beastiary of Experimental Designs](readings/Gotelli&EllisonChapter7.pdf)  
__Etherpad:__ https://etherpad.wikimedia.org/p/607-causal-2022  
__Lab:__ Discussion of papers (see [here](https://docs.google.com/spreadsheets/d/1r0VfnAJ3tuJufnLnrVC6Nx0qiyP4l6QILarKTsduov0/edit?usp=sharing) for assignments)  
...
```
`r datestring`   
__Lecture:__  [Papers](readings/obs_sampling.zip)  Discussion About Observational Studies, Thanksgiving Break!  
