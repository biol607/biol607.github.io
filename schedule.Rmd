...
```
`r datestring`   
__Lecture:__ Beyond Linear Regression, But Still Linear [Modeling Error](./lectures/modeling_variance.html), [Entering a non-normal world with Generalized Linear Models](lectures/25_generalized_linear_models.html)   
