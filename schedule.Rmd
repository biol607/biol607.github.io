...
```
`r datestring`   
__Lecture:__  [Data import, libraries, factors and forcats](lectures/06_read_data_libraries.html),  [Data manipulation, summarization, and making it tidy](https://datacarpentry.org/R-ecology-lesson/03-dplyr.html),  [Functions](lectures/functions.html)  
...
__Reading:__ W&S 1,3-4,  [Dplyr cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdfPaperpile)  
...
__Packages for The Week:__ ` install.packages(c("car", "emmeans", "multcompView", "contrast"))`
__Etherpad:__ https://etherpad.wikimedia.org/p/607-anova-2022
...
__Etherpad:__ https://etherpad.wikimedia.org/p/607-experiments-2022  
...
**FINAL PRESENTATIONS Fri. Dec 16th in Lab Slot**
**FINAL PAPERS DUE Dec 20th**
