...
```
`r datestring`   
__Lecture:__  [Data import, libraries, factors and forcats](lectures/06_read_data_libraries.html),  [Data Manipulation](https://swcarpentry.github.io/r-novice-gapminder/13-dplyr/), [Tidy data](lectures/17_tidy.html), [Functions](lectures/functions.html)  
