...
__Etherpad:__ https://etherpad.wikimedia.org/p/607-linear_everywhere-2020
 __In Class Code:__ [lots of anova](./in_class_code/2020/scripts/comparing_means.R)  
...
```
`r datestring`   
__Lecture:__ Categorical Predictors and ANOVA [part 1](lectures/19_expts_anova.html), [part 2](lectures/20_anova_2.html), Cottingham discussion    
...
```
`r datestring`   
__Lectures:__ Analyzing a Multicausal World - [Multiway ANOVA](lectures/21_multiway_anova.html), [Factorial ANOVA](lectures/22_factorial_anova.html)    
...
__In Class Code:__  [Fitting a line with Bayesian techniques](lab/08_bayes.html), [ancova, mlr, and aic](./in_class_code_2020/scripts/mlr_int_aic.R)  
...
```
`r datestring`   
__Lecture:__  Strategies for Deriving Causal Inference by Building Useful Models
...
```
`r datestring`   
__Lecture:__ [GIS in R](https://biol355.github.io/Lectures/17_gis_in_r.html), 
  
__Lab__:[Lessons 1,2, 6-8 from Data Carpentry Geospatial Lab](https://datacarpentry.org/r-raster-vector-geospatial/), [mapping Covid-19](https://biol355.github.io/Labs/coronavirus_spatial.html)  
