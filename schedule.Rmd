...
```
`r datestring`   
__Lecture:__ [Sampling](lectures/03_sampling_lecture_x.html) and [Simulation for Estimation](lectures/04_simulation_estimation.html). Descriptive statistics, and the creation of good observational sampling designs.   
