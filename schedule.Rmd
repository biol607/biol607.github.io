...
```
`r datestring`   
__Lecture:__  [Data import, libraries, factors and forcats](lectures/06_read_data_libraries.html),  [Data manipulation, summarization, and making it tidy](https://datacarpentry.org/R-ecology-lesson/03-dplyr.html)    
...
```
`r datestring`   
__Lecture:__ Descriptive statistics, probability distributions, simulation and sample size - [Functions](lectures/functions.html), [Sampling](lectures/03_sampling_lecture_x.html) and [Simulation for Estimation](lectures/04_simulation_estimation_x.html).   
