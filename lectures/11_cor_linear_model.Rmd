...
## Etherpad
<br><br>
<center><h3>https://etherpad.wikimedia.org/p/607-lm</h3></center>
...
$$\Huge Visits_i = \beta_0 + \beta_1 Resemblance_i + \epsilon_i$$
<br><br>
$$\Huge \epsilon_i ~ N(0, \sigma)$$
...
>     - Test be looking at relationship between fitted and observed values
...
3. Build a test
4. Evaluate test assumptions
<font color="red"><h5>5. Evaluate test results</h5></font>
6. Visualize
