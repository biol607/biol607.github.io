...
## Maximum Likelihood
<br>
<h2 style="text-align:left">The Maximum Likelihood Estimate is the value at which $p(D | \theta)$ is
highest.</h2>
<br>
<span class="fragment" style="text-align:left">Note the explicit choice of parameters.
...
<Br><br>
<span class="fragment">Brute force, or simple iterative ML</span>
</div>
