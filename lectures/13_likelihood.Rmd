...
> 1. Setup a grid of values for  b<sub>1</sub> that you think span >95% CI  <br>
> 2. For each value, get the MLE of b<sub>2</sub>. Record the MLL  <br>
> 3. Now, plot the vaue of  b<sub>1</sub> versis the MLL and use this MLL **profile** to calculate your CI  
